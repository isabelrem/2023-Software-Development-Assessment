...
add_new_record(pid = "O107",panel_id = 9,panel_name = "buddy is a lovely birb",panel_version = 1,GMS= "yes",gene_number= 2,r_code= "R38", transcript = "a really good one",genome_build = 37,bed_file= "placeholder")
